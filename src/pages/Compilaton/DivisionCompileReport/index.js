    ...
    <div className="wrapper reports" style={{ marginBottom: "2rem" }} dir="rtl">
      ...
      >
        <div className="row">
          ...
          <p>{data?.["jamiaatA-start"] + data?.["jamiaatA-increase"]}</p>
        ...
        <div className="row">
          ...
          <p>{data?.["jamiaatB-start"] + data?.["jamiaatB-increase"]}</p>
        ...
        <div className="row">
          ...
          <p>{data?.["jamiaatC-start"] + data?.["jamiaatC-increase"]}</p>
        ...
        <div className="row">
          ...
          <p>{data?.["jamiaatD-start"] + data?.["jamiaatD-increase"]}</p>
        ...
        <div className="row">
          ...
          <p>{data?.["jamiaatE-start"] + data?.["jamiaatE-increase"]}</p>
      ...
      >
        <div className="row">
          ...
          <p>{data?.["collegesA-start"] + data?.["collegesA-increase"]}</p>
        ...
        <div className="row">
          ...
          <p>{data?.["collegesB-start"] + data?.["collegesB-increase"]}</p>
        ...
        <div className="row">
          ...
          <p>{data?.["collegesC-start"] + data?.["collegesC-increase"]}</p>
        ...
        <div className="row">
          ...
          <p>{data?.["collegesD-start"] + data?.["collegesD-increase"]}</p>
