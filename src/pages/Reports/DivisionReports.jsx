    ...
    <>
      <div className="md:join xs:w-full mb-4 flex justify-between items-center">
        ...
        <div className="indicator flex items-center justify-end w-full">
          ...
          <button
            className={`font-inter px-2 text-[12px] md:text-[14px] bg-primary flex justify-center text-white p-1 md:p-[6px] mb-1 rounded font-medium leading-[20px] text-left ${
