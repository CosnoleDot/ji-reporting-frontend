...
export const BottomNav = ({ active }) => {
  ...
  return (
    <div className="fixed top-16 left-0 h-screen bg-white text-gray-300 flex flex-col border-r border-inputBorder">
      {/* Dashboard Link */}
      <div className="flex flex-col w-full gap-4 p-4 mb-4 border-b border-inputBorder">
        ...
        <div className="flex w-full items-center justify-center">
          <button onClick={() => navigate("/profile")} className="w-full hover:bg-primary hover:text-white p-2 font-inter text-[14px] leading-5 font-medium rounded text-heading text-center border border-inputBorder">
            Edit Profile
          </button>
        </div>
      </div>
