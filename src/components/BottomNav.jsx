...
export const BottomNav = ({ active }) => {
  ...
  return (
    <div className="fixed top-16 left-0 h-[calc(100vh-65.6px)] bg-white text-gray-300 flex flex-col border-r border-inputBorder">
      {/* Dashboard Link */}
      <div className="flex flex-col w-full gap-4 p-4 mb-4 border-b border-inputBorder">
        ...
        <div className="flex w-full items-center justify-center">
          <button
            ...
            className="w-full hover:bg-primary hover:text-white p-2 font-inter text-[14px] leading-5 font-medium rounded text-heading text-center border border-inputBorder"
          >
            Edit Profile
          </button>
        </div>
      ...
      <div className="w-full flex items-start flex-col p-4">
        ...
        >
          <div className="flex items-center gap-4 ">
            ...
            <span className="font-medium text-[14px] leading-5">Dashboard</span>
          </div>
        </Link>
        ...
        localStorage.getItem("@nazimType") === "umeedwar" ? (
          ...
          >
            <div className="flex items-center gap-4 ">
              {" "}
              <VscGraph className="h-5 w-5" />
              <span className="font-medium text-[14px] leading-5">Reports</span>
            </div>
          </Link>
        )}
            ...
            <Link
              ...
              className={
                !active || active === "comparison"
                  ? "bg-primary text-white p-2 roundedw-full"
                  : "bg-blue-50 p-2 rounded text-heading w-full"
              }
            >
              <div className="flex items-center gap-4 ">
      ...
      <div className="w-full flex items-center justify-start">
        <div className="flex items-center gap-2 cursor-pointer p-4"  onClick={() => {
                    localStorage.clear();
                    navigate("/login");
